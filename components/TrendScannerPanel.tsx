...
const ASSETS: MarketAsset[] = [
    ...
    { symbol: 'AUDNZD', name: 'AUD/NZD (Australian / New Zealand Dollar)', category: 'forex_minors' },
    { symbol: 'AUDCAD', name: 'AUD/CAD (Australian / Canadian Dollar)', category: 'forex_minors' },
    { symbol: 'AUDCHF', name: 'AUD/CHF (Australian Dollar / Swiss Franc)', category: 'forex_minors' },
    { symbol: 'AUDJPY', name: 'AUD/JPY (Australian Dollar / Yen)', category: 'forex_minors' },
    { symbol: 'CADCHF', name: 'CAD/CHF (Canadian Dollar / Swiss Franc)', category: 'forex_minors' },
    { symbol: 'CADJPY', name: 'CAD/JPY (Canadian Dollar / Yen)', category: 'forex_minors' },
    { symbol: 'CHFJPY', name: 'CHF/JPY (Swiss Franc / Yen)', category: 'forex_minors' },
    { symbol: 'EURAUD', name: 'EUR/AUD (Euro / Australian Dollar)', category: 'forex_minors' },
    { symbol: 'EURCAD', name: 'EUR/CAD (Euro / Canadian Dollar)', category: 'forex_minors' },
    { symbol: 'EURCHF', name: 'EUR/CHF (Euro / Swiss Franc)', category: 'forex_minors' },
    { symbol: 'EURGBP', name: 'EUR/GBP (Euro / British Pound)', category: 'forex_minors' },
    { symbol: 'EURJPY', name: 'EUR/JPY (Euro / Japanese Yen)', category: 'forex_minors' },
    { symbol: 'EURNZD', name: 'EUR/NZD (Euro / New Zealand Dollar)', category: 'forex_minors' },
    { symbol: 'GBPAUD', name: 'GBP/AUD (Pound / Australian Dollar)', category: 'forex_minors' },
    { symbol: 'GBPCAD', name: 'GBP/CAD (Pound / Canadian Dollar)', category: 'forex_minors' },
    { symbol: 'GBPCHF', name: 'GBP/CHF (Pound / Swiss Franc)', category: 'forex_minors' },
    { symbol: 'GBPJPY', name: 'GBP/JPY (Pound / Japanese Yen)', category: 'forex_minors' },
    { symbol: 'GBPNZD', name: 'GBP/NZD (Pound / New Zealand Dollar)', category: 'forex_minors' },
    { symbol: 'NZDCAD', name: 'NZD/CAD (New Zealand / Canadian Dollar)', category: 'forex_minors' },
    { symbol: 'NZDCHF', name: 'NZD/CHF (New Zealand Dollar / Swiss Franc)', category: 'forex_minors' },
    { symbol: 'NZDJPY', name: 'NZD/JPY (New Zealand Dollar / Yen)', category: 'forex_minors' },
