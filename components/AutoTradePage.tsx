...
export const AutoTradePage: React.FC<AutoTradePageProps> = ({ onBack, userMetadata }) => {
    ...
    const renderLocked = () => (
        <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 uppercase tracking-widest">Terminal Locked</h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-md mb-8 font-medium">
                Access to the Neural Auto-Trade Terminal is restricted. 
                Request authorization from the GreyAlpha core to enable algorithmic execution.
            </p>
            <button 
                onClick={handleRequestAccess}
                className="px-10 py-4 bg-green-600 hover:bg-green-500 text-white font-black uppercase tracking-widest rounded-2xl transition-all shadow-lg hover:shadow-green-500/30"
            >
    ...
    const renderPending = () => (
        <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 uppercase tracking-widest">Authorization Pending</h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-md mb-8 font-medium">
                Your request for Auto-Trade access is currently being reviewed by our quantitative team. 
                Neural links will be established once verified.
            </p>
        </div>
    );
