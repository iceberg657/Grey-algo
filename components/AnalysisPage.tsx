            ...
            <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 flex-grow flex flex-col">
                <header className="relative mb-12 flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <button
                            onClick={onLogout}
                            className="bg-white/10 dark:bg-slate-800/40 backdrop-blur-sm border border-white/20 dark:border-white/10 text-gray-700 dark:text-green-400 hover:bg-red-500/20 hover:text-red-400 px-4 py-2 rounded-xl transition-all text-xs font-black uppercase tracking-widest shadow-md"
                            aria-label="Logout"
                        >
                            Exit
                        </button>
                ...
                <main className="relative group flex-grow perspective-1000">
                    ...
                    <div className={`
                        bg-white/10 dark:bg-slate-900/40 backdrop-blur-xl p-6 sm:p-10 rounded-2xl border border-white/20 dark:border-white/10 
