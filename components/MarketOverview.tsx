        ...
        <div className="bg-white/60 dark:bg-dark-card/60 backdrop-blur-lg p-4 sm:p-6 rounded-2xl border border-gray-300/20 dark:border-green-500/20 shadow-2xl mb-8">
            ...
            <a href="https://www.tradingview.com/" target="_blank" rel="noopener noreferrer" className="block cursor-pointer group">
                ...
                <TiltCard intensity={5}>
                    <div className="h-40 bg-white/20 dark:bg-black/10 rounded-lg p-2">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <TiltCard className="h-full">
                    <div className="bg-dark-card/60 p-4 rounded-xl shadow-lg border border-green-500/10 flex flex-col justify-between min-h-[120px] h-full">
                ...
                <TiltCard className="h-full">
                 ...
                 {/* Analysis Count Card */}
                <TiltCard className="h-full">
                    <div className="bg-dark-card/60 p-4 rounded-xl shadow-lg border border-green-500/10 flex flex-col justify-between min-h-[120px] relative group h-full">
                        <div className="flex justify-between items-start">
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            {globalAnalysis.sectors.map((sector) => (
                                <TiltCard key={sector.asset}>
                                    <div className={`p-3 rounded-xl border flex flex-col justify-between ${getBiasColor(sector.bias)} h-full`}>
