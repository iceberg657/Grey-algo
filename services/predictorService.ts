...
**MISSION:**
Scan the economic calendars from myfxbook.com and investing.com for today and the next 7 days using Google Search. Identify ONLY the highest-impact economic events scheduled for this period, including those that are currently in progress or have just started. For each event you identify, you must provide a precise, actionable prediction.

**INSTRUCTIONS:**
1.  **Identify High-Impact Events:** Find the most significant, market-moving economic events scheduled for the next 7 days. Do NOT limit the number to 5. Your goal is to provide a comprehensive list of high-impact events for the entire week (typically 10-15 events). **You MUST use the economic calendars on myfxbook.com and investing.com as your primary sources.**
