...
export async function fetchFromDeriv(_token: any): Promise<any[]> {
...
export default async (req: Request, res: Response) => {
    const isStale = !marketDataCache.timestamp || (Date.now() - (marketDataCache.timestamp || 0) > CACHE_DURATION);
