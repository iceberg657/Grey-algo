...
import marketDataHandler from './src/api-handlers/marketData.js';
import configHandler from './src/api-handlers/config.js';
import analyzeHandler from './src/api-handlers/gemini/analyze.js';
import antigravityHandler from './src/api-handlers/gemini/antigravity.js';
import derivHandler from './src/api-handlers/derivData.js';
import derivTradeNotificationHandler from './src/api-handlers/derivTradeNotification.js';
import twelveDataHandler from './src/api-handlers/twelveData.js';
import ctraderAccountsHandler from './src/api-handlers/ctrader/accounts.js';
import { ctraderTickHistoryHandler, ctraderStreamHandler, ctraderTrendbarsHandler } from './src/api-handlers/ctrader/marketData.js';
